...
| BSI_ALL | 기업경기실사지수 전산업 | nan | BSI | 202410 |
...
| 시리즈 ID | 지표명 | 최신값 | 단위 | 기준일 |
|---------|------|------|-----|------|
| RETAIL_SALES_YOY | 소매판매 전년비 | nan | % | 202604 |
| CSI | 소비자동향CSI | nan | 지수 | 202304 |

## 09_금융시장

| 시리즈 ID | 지표명 | 최신값 | 단위 | 기준일 |
|---------|------|------|-----|------|
| KOSPI | KOSPI 지수(월평균) | nan | pt | N/A |
| KOSDAQ | KOSDAQ 지수(월평균) | nan | pt | N/A |
